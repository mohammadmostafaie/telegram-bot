...
async def get_day(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    buttons = [[t] for t in TIMES[context.user_data["day"]]]
...
if __name__ == "__main__":
    application.run_webhook(
        listen="0.0.0.0",
        port=10000,
        webhook_url="https://telegram-bot-8frm.onrender.com/توکن_خودت",
    )
